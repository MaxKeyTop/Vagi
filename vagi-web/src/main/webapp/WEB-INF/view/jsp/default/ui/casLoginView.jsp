...
$(function(){
	...
	$('#j_captcha_image').click(function () {//
           $(this).attr("src", '<c:url value="/captcha"/>?t='+(new Date().getTime())); 
	}); 
	
	if($.cookie("username")!=undefined&&$.cookie("username")!=""){
		$("input[name=username]").val($.cookie("username")==undefined?"":$.cookie("username"));
	}
});
</script>
<div class="box" id="login">
    <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true"  onsubmit="return doLoginSubmit();">
			...
			<tbody>
				...
				<tr><td  style="white-space:nowrap" nowrap>
					 <spring:message code="screen.welcome.label.captcha.accesskey" var="captchaAccessKey" />
           			 <input type='text' id="j_captcha" name="j_captcha"  tabindex="3"  size="25"  path="captcha"  accesskey="${captchaAccessKey}" htmlEscape="true" autocomplete="off" />
           			 <img id="j_captcha_image" src='<c:url value="/captcha"/>' />
            		<span id="capslock-on" style="display:none;"><p><img src="images/warning.png" valign="top"> <spring:message code="screen.capslock.on" /></p></span>
				</td></tr>
				 <!--
				<tr><td>
				 ...
				 -->
				 <tr><td  style="white-space:nowrap" nowrap>
	                <input type="checkbox" name="rememberMe" id="rememberMe" value="true" tabindex="5"  style="float:left;" />
	                <label for="rememberMe"><spring:message code="screen.rememberme.checkbox.title" /></label>
				...
				<tr><td>
					<spring:message code="screen.welcome.label.loginwith.following" />
				</td></tr>
				<tr><td>
					<a href="<c:url value="/logon/oauth20/authorize/qq"/>">
					 	<img style="width:32px;height:32px;"  src='<c:url value="/images/social/qq.png"/>' />
					</a>
					
					<a href="<c:url value="/logon/oauth20/authorize/sinaweibo"/>">
					 <img  style="width:32px;height:32px;"  src='<c:url value="/images/social/sinaweibo.png"/>' />
					</a>
				</td></tr>
			</tbody>
		</table>
